...
def evaluate_failure_prediction(cfg, heatmap_type, simulation_name, summary_type, aggregation_method, condition):
    ...
    for seconds in range(1, 4):
        ...
        if not os.path.exists('results/dynamic/t99999/'+'ThirdEye.csv'):
            with open('results/dynamic/t99999/'+'ThirdEye.csv', mode='w',
            ...
            with open('results/dynamic/t99999/'+'ThirdEye.csv', mode='a',
                      newline='') as result_file:
                writer = csv.writer(result_file,
                                    delimiter=',',
                                    quotechar='"',
